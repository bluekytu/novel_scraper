...
const TextBox = ({ onSubmitNovelName }) => {
    ...
    return (
            ...
            <div className="flex items-center border-b border-teal-500 py-2">
                <input value={NovelName} className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Enter Novel" aria-label="Full name" onChange={e => {setNovelName(e.target.value)}}></input>
